...
| D-019 | 2026-09-25 | Scoring MVP: exact 5 / result + GD 3 / result 2; 90-min result for all matches; void on cancel/award/long postponement | Simple and explainable (Part 7) | **Approved (founder)** |
| D-020 | 2026-09-25 | Club-vs-club = mean points of active fans, min 30 active fans; primary club changeable once per season | Rewards quality, not fan-base size (Part 8) | **Approved (founder)** |
...
| D-039 | 2026-09-25 | Brand name decided by a **community vote** in the test league between **FootGooal** (founder's candidate, replacing GOOOAL), **Mudarraj (مدرّج)** and **KooraCall (كورة كول)**. Counsel runs a trademark check on the winner (note: similar existing "FootGoal" apps). Neutral (non-club) colour system | Part 18 | **Approved (founder)** |
| D-040 | 2026-09-25 | Repository name: **KooraCall** (private). Replaces GOOOAL (D-038). The public app name is still decided by the community vote (D-039) | Founder decision | **Approved (founder)**. Founder must create the repo and grant the Claude GitHub App access |
