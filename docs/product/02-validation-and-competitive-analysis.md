...
| **Sportmonks** | Free (2 leagues); Starter €29/mo (5 leagues); Growth €99/mo (30); Pro €249/mo (120); Enterprise custom. 14-day trial ([Sportmonks pricing](https://www.sportmonks.com/football-api/plans-pricing/), via search summary) **[verify]** | Claims 2,200+ leagues | Strong candidate. League-count-based pricing fits our ~10-competition plan |
